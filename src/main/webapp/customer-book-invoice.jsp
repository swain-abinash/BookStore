	...
	<div id="exampl">
		...
		<center>
			<table border="2" cellspacing="2" cellpadding="2" width="80%">
				<tr>
					<td colspan="7"><strong><center>Book Shopping Order Receipt</center></strong></td>
				</tr>
				<%
					int isRepeat = 0;
					int srNo = 0;
					...
					ResultSet totalBillResult = DatabaseConnection.getResultFromSqlQuery("select sum(book_total_price) from tblorder where customer_name='" + customerName+ "' and payment_id='"+session.getAttribute("paymentId")+"'");
				...
				<tr>
					...
					<td><del><%=resultset.getString("book_mrp_price")%></del></td>
					<td><%=resultset.getString("book_discount_price")%></td>
					<td><%=resultset.getString("book_total_price")%></td>
				</tr>
				<%
					}
				%>
			...
			<div class="checkout-left">
				<div class="checkout-right-basket animated wow slideInRight"
					data-wow-delay=".5s">
					<a href="books.jsp"><span class="glyphicon glyphicon-menu-left"
